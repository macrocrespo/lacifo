        ...
        <table class="display table table-bordered table-striped listado">
            ...
            <tr>
                ...
                <td>
                    ...
                    $txt .= 'Tipo: '.$r->tipo_producto_nombre;
                    ?>
                ...
                <td class="no-phone">
                    <a title="Ver detalles" href="<?php echo Yii::app()->request->baseUrl.'/tipo_producto/'.$r->tipo_producto_id; ?>">
                        <?php echo $r->tipo_producto_nombre; ?>
                    </a>
                </td>
...
$this->widget('Mensaje', array(
    'mensaje'   => 'No se han cargado productos para este rubro.',
    'type'      => 'warning',
    'show_icon' => true,
    'close'     => false
));
